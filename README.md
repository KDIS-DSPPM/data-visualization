...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/KDIS-DSPPM/data-visualization/main/?urlpath=rstudio)
...
with ggplot2](https://pkg.garrickadenbuie.com/gentle-ggplot2/#1)
  ...
  - Dai, T., Rosenberg, J. M., & +Lawson, M. A. (2020). [Data representations and visualizations in educational research. In T. L. Good & M. McCaslin](https://www.taylorfrancis.com/entries/10.4324/9781138609877-REE148-1/data-representations-visualizations-educational-research-ting-dai-joshua-rosenberg-michael-lawson) (Eds.), Educational Psychology Section; D. Fisher (Ed.), Routledge Encyclopedia of Education (Online). Taylor & Francis: New York, NY.
...
* Reading
  ...
  - 3Blue1Brown (2016). [Essence of Linear Algebra Preview](https://www.youtube.com/watch?v=kjBOesZCoqc)
